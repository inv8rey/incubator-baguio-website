...
<div style="position:relative;background:#0B0B0D;padding:44px 40px 48px;overflow:hidden;text-align:center;">
  ...
  <div style="position:relative;max-width:680px;margin:0 auto;">
    ...
    <h1 style="margin:0;font-size:36px;line-height:1.15;font-weight:700;letter-spacing:-0.03em;color:#fff;">Welcome back</h1>
    <p style="margin:14px auto 0;font-size:15px;line-height:1.6;color:rgba(255,255,255,0.6);max-width:520px;">Log in to manage your startup profile, challenges, and mentor connections.</p>
  </div>
</div>
`;
