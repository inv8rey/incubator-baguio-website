...
const TOP_HTML = `
<!-- HEADER -->
<div style="display:flex;align-items:center;justify-content:center;padding:20px 40px;background:#100D0B;">
  <div style="display:flex;align-items:center;gap:11px;">
    <img src="${BP}/assets/city-of-baguio-seal.png" alt="City of Baguio" style="height:42px;width:auto;"><img src="${BP}/assets/cpdso-logo.png" alt="CPDSO" style="height:42px;width:auto;">
...
<!-- HERO -->
<div style="position:relative;background:#100D0B;padding:88px 40px 64px;overflow:hidden;text-align:center;">
...
<!-- WHAT'S INSIDE -->
<div style="background:#F6F2EA;padding:80px 40px;border-top:1px solid rgba(64,50,34,0.09);">
  <div style="max-width:1060px;margin:0 auto;">
    <div style="text-align:center;margin-bottom:48px;">
      ...
      <h2 style="margin:0;font-size:38px;font-weight:500;letter-spacing:-0.03em;color:#1A1714;line-height:1.1;">Designed to connect Baguio&rsquo;s innovation ecosystem.</h2>
      <p style="margin:14px auto 0;font-size:15.5px;line-height:1.6;color:#5A544B;max-width:600px;">Browse ecosystem directories, discover innovation challenges, connect with mentors, and stay informed through a shared calendar of research and innovation activities.</p>
    </div>
    <div class="ib-teaser-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;">
      ...
      <div class="ib-card-hover" style="background:#fff;border:1px solid rgba(64,50,34,0.12);border-radius:18px;padding:26px 22px;border-top:3px solid ${c[0]};display:flex;flex-direction:column;">
        ...
        <h3 style="margin:0 0 8px;font-size:16.5px;font-weight:600;color:#1A1714;">${c[3]}</h3>
        <p style="margin:0;font-size:13.5px;line-height:1.55;color:#5A544B;">${c[4]}</p>
      </div>`).join("")}
    </div>
  </div>
</div>
...
<div id="join" style="scroll-margin-top:24px;background:#F6F2EA;padding:80px 24px 0;border-top:1px solid rgba(64,50,34,0.09);">
...
const BOTTOM_HTML = `
<!-- FOOTER -->
<div style="background:#100D0B;padding:40px 24px;text-align:center;">
  <div style="display:inline-flex;align-items:center;gap:10px;margin-bottom:12px;">
    <img src="${BP}/assets/city-of-baguio-seal.png" alt="City of Baguio" style="height:36px;width:auto;"><img src="${BP}/assets/cpdso-logo.png" alt="CPDSO" style="height:36px;width:auto;">
