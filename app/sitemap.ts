...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: { path: string; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; priority: number }[] = [
    ...
    { path: "/idea-lab/", changeFrequency: "monthly", priority: 0.6 },
    { path: "/idea-lab/bank/", changeFrequency: "weekly", priority: 0.5 },
    { path: "/research-innovation-agenda/", changeFrequency: "monthly", priority: 0.6 },
    ...
    { path: "/challenges/community/", changeFrequency: "weekly", priority: 0.6 },
    ...
    { path: "/pinasiklab/", changeFrequency: "weekly", priority: 0.7 },
    { path: "/pinasiklab/partner/", changeFrequency: "monthly", priority: 0.5 },
    { path: "/contact/", changeFrequency: "monthly", priority: 0.5 },
    { path: "/get-started/", changeFrequency: "monthly", priority: 0.6 },
    { path: "/path-finder/", changeFrequency: "monthly", priority: 0.7 },
    ...
    { path: "/startup-terms/", changeFrequency: "monthly", priority: 0.5 },
