...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    color: "#D9531E",
    terms: [
      { term: "Intellectual Property", definition: "Legal rights over creations of the mind — including inventions, designs, brand names, and creative works — that allow an owner to control and benefit from their use." },
      ...
      { term: "Copyright", definition: "Legal protection automatically given to an original creative work — such as writing, software, images, or music — giving the creator exclusive rights to reproduce, distribute, and adapt it." },
      { term: "Industrial Design", definition: "Legal protection for the unique visual appearance of a product — its shape, pattern, or ornamentation — as distinct from how the product functions." },
      { term: "NDA", definition: "A Non-Disclosure Agreement is a legal contract in which the parties agree to keep specified information confidential, commonly used before sharing sensitive business, product, or research details with a potential partner or investor." },
