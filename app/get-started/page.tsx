...
const STATS: { color: string; icon: string; title: string; desc: string }[] = [
  {
    ...
    desc: "Innovators, universities, TBIs, investors, and partners.",
  },
  {
    color: "#F26522",
...
<div style="display:flex;align-items:center;justify-content:space-between;padding:16px 40px;background:#131110;position:sticky;top:0;z-index:50;">
  ...
  <div style="display:flex;align-items:center;gap:28px;">
    ...
    <div style="display:flex;align-items:center;gap:10px;">
      <a href="${BP}/ecosystem-signup" class="ib-cta-orange" style="display:inline-flex;align-items:center;gap:8px;background:#F26522;color:#fff;font-weight:600;font-size:14px;padding:11px 22px;border-radius:9999px;text-decoration:none;">Sign Up <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.4"><path d="M5 12h14M13 6l6 6-6 6"></path></svg></a>
