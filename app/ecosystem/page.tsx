...
<div style="position:relative;background:#100D0B;padding:56px 40px 56px;overflow:hidden;text-align:center;">
  ...
  <div style="position:relative;max-width:840px;margin:0 auto;">
    <div style="font-size:12.5px;color:rgba(255,255,255,0.55);margin-bottom:22px;"><a href="${BP}/" style="color:inherit;text-decoration:none;">Home</a> <span style="margin:0 6px;">/</span> <span style="color:rgba(255,255,255,0.7);">Ecosystem</span></div>
