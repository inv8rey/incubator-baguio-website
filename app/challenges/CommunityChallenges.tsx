...
export default function CommunityChallenges({ bp }: { bp: string }) {
  ...
  return (
    <div style={{ background: "#fff", padding: "64px 40px", borderTop: "1px solid rgba(64,50,34,0.09)" }}>
      <div style={{ maxWidth: 1080, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 32, fontWeight: 600, letterSpacing: "-0.025em", color: DARK }}>Community-posted challenges</h2>
          <p style={{ margin: "12px auto 0", fontSize: 14.5, lineHeight: 1.6, color: "#5A544B", maxWidth: 520 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18 }} className="ib-ecosystem-grid">
          {items.map((c) => (
            <a
              ...
              style={{ display: "block", background: "#F6F2EA", border: "1px solid rgba(64,50,34,0.13)", borderRadius: 18, padding: 24, textDecoration: "none" }}
            >
