...
<div style="position:relative;background:#1F4C8C;padding:44px 40px 46px;overflow:hidden;border-bottom:1px solid rgba(255,255,255,0.08);">
  <svg style="position:absolute;top:24px;right:60px;opacity:0.16;pointer-events:none;" width="240" height="200" viewBox="0 0 120 104" fill="none" aria-hidden="true">
    <polyline points="12,40 60,12 108,40" stroke="#F2C240" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></polyline>
    <polyline points="12,62 60,34 108,62" stroke="#F2C240" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></polyline>
    <polyline points="12,84 60,56 108,84" stroke="#F2C240" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"></polyline>
  </svg>
  <div style="position:relative;max-width:1240px;margin:0 auto;">
    <div style="font-size:12.5px;color:rgba(255,255,255,0.5);margin-bottom:22px;">
      ...
      <span style="margin:0 8px;">&rsaquo;</span>
      <span style="color:#F2C240;">Team Finder</span>
    </div>
    <h1 style="margin:0;font-size:46px;font-weight:600;letter-spacing:-0.032em;color:#fff;line-height:1.1;">Find your <span style="color:#F2C240;">team</span></h1>
