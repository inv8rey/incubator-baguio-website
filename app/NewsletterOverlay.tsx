...
// there), and on auth pages the PinaSIKLab application form, and the Idea Lab
// (already mid-flow on something else, and it covers the Generate button on phones). The admin
...
function shouldSkip(pathname: string): boolean {
  return pathname.startsWith("/unsubscribe") || pathname.startsWith("/login") || pathname.startsWith("/signup") || pathname.startsWith("/pinasiklab/register") || pathname.startsWith("/idea-lab");
}
