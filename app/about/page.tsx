...
<div style="position:relative;background:#100D0B;padding:64px 40px 70px;overflow:hidden;text-align:center;">
  ...
  <div style="position:relative;max-width:860px;margin:0 auto;">
    <div style="font-size:12.5px;color:rgba(255,255,255,0.55);margin-bottom:22px;"><a href="${BP}/" style="color:inherit;text-decoration:none;">Home</a> <span style="margin:0 6px;">/</span> <span style="color:rgba(255,255,255,0.7);">About</span></div>
  ...
  <div style="max-width:1080px;margin:0 auto;">
    ...
    <div class="ib-about-functions" style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;">
      ${[
        ...
        ["#FBF3EC", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#D9531E" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21V10"></path><path d="M12 10C12 10 7.5 10.5 6 6.5C6 6.5 11 5.5 12 10Z"></path><path d="M12 10C12 10 16.5 10.5 18 6.5C18 6.5 13 5.5 12 10Z"></path></svg>`, "Project Development", "We help you strengthen an idea before you build it."],
        ["#E8EEF4", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#22596F" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"></circle><path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6"></path><circle cx="17" cy="7" r="2.5"></circle><path d="M21 19c0-2.4-1.8-4.5-4-5"></path></svg>`, "Ecosystem Collaboration", "We introduce you to the people who can actually help."],
        ["#F8F0F3", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#8E2749" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"></path><path d="M10 22h4"></path><path d="M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.2 1 2.3h6c0-1.1.4-1.8 1-2.3A7 7 0 0 0 12 2Z"></path></svg>`, "Open Innovation & City Adoption", "We turn real city problems into challenges anyone can solve."],
        ["#EFF4F1", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#17603A" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="8" ry="3"></ellipse><path d="M4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5"></path><path d="M4 12c0 1.66 3.58 3 8 3s8-1.34 8-3"></path></svg>`, "Innovation Intelligence", "We track the ecosystem so decisions use evidence, not guesses."],
      ].map((c) => `
  ...
  <div style="max-width:1080px;margin:0 auto;display:grid;grid-template-columns:0.85fr 1.15fr;gap:52px;align-items:center;">
    ...
    <div>
      ...
      <div style="display:flex;gap:14px;flex-wrap:wrap;">
        ...
        ].map((chip) => `<div style="background:#FBFAF6;border:1px solid rgba(64,50,34,0.11);border-radius:14px;padding:16px 20px;"><div style="font-size:13px;font-weight:600;color:#1A1714;">${chip[0]}</div><div style="font-size:12.5px;color:#6E685F;margin-top:3px;">${chip[1]}</div></div>`).join("")}
      </div>
    </div>
  </div>
</div>
