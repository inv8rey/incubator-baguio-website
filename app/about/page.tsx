  ...
  <div style="max-width:1080px;margin:0 auto;">
    <div style="display:grid;grid-template-columns:1fr 1.1fr;gap:52px;align-items:center;margin-bottom:44px;">
      ...
      <div style="position:relative;border-radius:20px;overflow:hidden;aspect-ratio:16/11;background:#FFEEDD;">
        ...
        <span style="position:absolute;left:16px;bottom:16px;font-size:11.5px;font-weight:600;letter-spacing:0.06em;color:#fff;background:rgba(64,50,34,0.45);backdrop-filter:blur(6px);padding:7px 14px;border-radius:9999px;">Baguio City &middot; City of Pines &middot; 1,540 MASL</span>
      </div>
    </div>
    ...
    <div class="ib-about-functions" style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;">
      ${[
        ...
        ["#FBF3EC", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#D9531E" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21V10"></path><path d="M12 10C12 10 7.5 10.5 6 6.5C6 6.5 11 5.5 12 10Z"></path><path d="M12 10C12 10 16.5 10.5 18 6.5C18 6.5 13 5.5 12 10Z"></path></svg>`, "Founder Development", "Helping entrepreneurs turn ideas into sustainable ventures."],
        ["#E8EEF4", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#22596F" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"></circle><path d="M3 20c0-3.3 2.7-6 6-6s6 2.7 6 6"></path><circle cx="17" cy="7" r="2.5"></circle><path d="M21 19c0-2.4-1.8-4.5-4-5"></path></svg>`, "Ecosystem Building", "Connecting people, organizations, and opportunities."],
        ["#F8F0F3", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#8E2749" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"></path><path d="M10 22h4"></path><path d="M12 2a7 7 0 0 0-4 12.7c.6.5 1 1.2 1 2.3h6c0-1.1.4-1.8 1-2.3A7 7 0 0 0 12 2Z"></path></svg>`, "Open Innovation", "Turning real-world challenges into collaborative solutions."],
        ["#EFF4F1", `<svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#17603A" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="8" ry="3"></ellipse><path d="M4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5"></path><path d="M4 12c0 1.66 3.58 3 8 3s8-1.34 8-3"></path></svg>`, "Ecosystem Intelligence", "Enabling better decisions through data and insights."],
      ].map((c) => `
